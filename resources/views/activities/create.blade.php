                        ...
                        <fieldset class="border border-solid border-gray-300 p-6">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="flex row items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
                                    <input id="call" type="radio" value="1" name="is_done" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                   <label for="call" class="py-4 ml-2 w-full text-sm font-medium text-gray-900 dark:text-gray-300">Call</label>
                                    
                                    <input id="meeting" type="radio" value="0" name="is_done" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            ...
                            <div class="mb-4">
                                <x-inputs.text name="comment" label="{{ __('Comment') }}" value="{{ old('comment') }}" required autocomplete="comment" autofocus />
                            </div>
                            @error('comment')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                            ...
                            <div class="mb-4">
                                <b>{{ __('Done') }}</b>
                                <div class="flex row items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
                                    <input id="yes" type="radio" value="1" name="is_done" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                   <label for="yes" class="py-4 ml-2 w-full text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                                    
                                    <input id="no" type="radio" value="0" name="is_done" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
