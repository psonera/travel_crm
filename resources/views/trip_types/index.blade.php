        ...
        <div class="flex-none w-full max-w-full px-3">
            <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid inline-flex pb-2 rounded-t-2xl border-b-transparent">
                    ...
                    <a href="{{ route('trip_types.create') }}" class="bg-gradient-cyan ml-auto bg-success block p-2 rounded-xl text-white">+ Add New Trip Type</a>
                </div>
                                ...
                                @foreach ($trip_types as $index => $trip_type)
                                    <tr>
                                        ...
                                        <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                            <a href="{{ route('trip_types.edit', $trip_type) }}"
                                    ...
                                    <div class="relative bg-white align-center justify-center rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-6 text-center">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you
                                                sure you want to delete this Trip Type?</h3>
                                            
                                                
                                             <form id="delete-frm" class="DELETE" action="{{ route('trip_types.destroy',  $trip_type) }}" method="POST">
                                                @method('DELETE')
                                                @csrf                                             
                                            <button id="delete-frm" class="deletebtn" data-modal-toggle="popup-modal" type="submit" href="{{ route('trip_types.destroy',  $trip_type) }}"
