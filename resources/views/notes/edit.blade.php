        ...
        <div class="flex-none max-w-full ml-auto mr-auto px-3 w-full">
            <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                ...
                <div class="flex-auto p-6" role="tabpanel">
                    <form role="form" method="POST" action="{{ route('notes.update',$note) }}"> 
                        ...
                        <fieldset class="border border-solid border-gray-300 p-6">
                            ...
                            <div class="mb-4">
                                <x-inputs.text name="content" label="{{ __('Content') }}" value="{{ $note->content }}" required autocomplete="content" autofocus />
                            </div>
                            @error('content')
