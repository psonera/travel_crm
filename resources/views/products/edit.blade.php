                ...
                <div class="flex-auto p-6" role="tabpanel">
                    <form role="form" method="POST" action="{{ route('products.update',$product) }}">
                        ...
                        <fieldset class="border border-solid border-gray-300 p-6">
                            ...
                            <div class="mb-4">
                                <x-inputs.text name="sku" label="{{ __('Sku') }}" value="{{ $product->sku }}" required autocomplete="sku" autofocus />
                            </div>
                            @error('sku')
                            ...
                            <div class="mb-4">
                                <x-inputs.textarea name="name" label="{{ __('Name') }}">{{ $product->name }}</x-inputs.textarea>
                            </div>
                            @error('name')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                            ...
                            <div class="mb-4">
                                <x-inputs.text name="description" label="{{ __('Description') }}" value="{{ $product->description }}" required autocomplete="description" autofocus />
                            </div>
                            @error('description')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                            ...
                            <div class="mb-4">
                                <x-inputs.text name="quantity" label="{{ __('Quantity') }}" value="{{ $product->quantity }}" required autocomplete="quantity" autofocus />
                            </div>
                            @error('quantity')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                            ...
                            <div class="mb-4">
                                <x-inputs.text name="price" label="{{ __('Price') }}" value="{{ $product->price }}" required autocomplete="price" autofocus />
                            </div>
                            @error('price')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
