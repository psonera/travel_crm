<div class="add_product_form_{{ $i }}">
    <fieldset class="border border-solid border-gray-300 p-6 mb-8">
        ...
        <div class="mb-4 relative">
            <x-inputs.text name="products[product_{{ $i }}][name]" class="find_product"
        ...
        <div class="mb-4">
            <x-inputs.text name="products[product_{{ $i }}][price]" label="{{ __('Price') }}" class="edit_price" data-id="{{ $i }}"
             required autocomplete="price" autofocus />
        </div>

        <div class="mb-4">
            <x-inputs.text name="products[product_{{ $i }}][quantity]" label="{{ __('Quantity') }}" class="edit_qty" data-id="{{ $i }}"
        ...
        <x-inputs.hidden name="products[product_{{ $i }}][id]" class="product_id" />
