    ...
    <div class="flex flex-wrap -mx-3">
        <div class="flex-none w-full max-w-full px-3">
            <div
                ...
                <div
                    class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid inline-flex pb-2 rounded-t-2xl border-b-transparent mb-4">
                    <h2 class="text-3xl font-bold">All Leads</h2>
                    <a href="{{ route('leads.create') }}"
                        class="bg-gradient-cyan ml-auto bg-success block p-2 rounded-xl text-white">+ Add New Lead</a>
                </div>
                                ...
                                @foreach ($leads as $lead)
                                    <tr>
                                        ...
                                        <td
                                            class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                            <a href="#"
                                                class="mb-0 leading-tight text-slate-400">{{ $lead->user->name }}</a>
                                        </td>
                                        <td
                                        ...
                                        <td
                                            ...
                                            <p class="mb-0 leading-tight text-slate-400">
                                                {{ date('d/m/Y', strtotime($lead->expected_closed_date)) }}</p>
                                        </td>

                                        <td
                                            class="p-2 leading-normal text-center align-middle bg-transparent border-b text-size-sm whitespace-nowrap shadow-transparent">
                                            <p class="mb-0 leading-tight text-slate-400">
                                                {{ date('d/m/Y', strtotime($lead->created_at)) }}</p>
                                        </td>
                                        <td
                                            class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
