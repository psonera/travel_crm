        ...
        <div class="flex-none w-full max-w-full px-3">
            <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid inline-flex pb-2 rounded-t-2xl border-b-transparent">
                    <h2 class="text-3xl font-bold">All Lead Pipelines</h2>
                    <a href="{{ route('settings.lead_pipelines.create') }}" class="bg-gradient-cyan ml-auto bg-success block p-2 rounded-xl text-white">+ Add New Lead Pipeline</a>
                </div>
                <div class="flex-auto px-0 pt-0 pb-2">
                    <div class="p-0 overflow-x-auto">
                        <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                            ...
                            <tbody>
                                @foreach ($lead_pipelines as $index => $lead_pipeline)
                                    <tr>
                                        <td
                                        ...
                                        <div class="p-6 text-center">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you
                                             ...
                                             <form id="delete-frm" class="DELETE" action="{{ route('settings.lead_pipelines.destroy',$lead_pipeline) }}" method="POST">
                                                @method('DELETE')
                                                @csrf                                             
                                            <button id="delete-frm" class="deletebtn" data-modal-toggle="popup-modal" type="submit" href="{{ route('settings.lead_pipelines.destroy',$lead_pipeline) }}"
