                                ...
                                @foreach ($trip_types as $index => $trip_type)
                                    <tr>
                                        ...
                                        <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                            ...
                                            <a onclick="toggleModal('{{ $trip_type->id }}')" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 rounded-full focus:ring-4 focus:ring-red-300 font-medium text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900 cursor-pointer"> Delete</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
...
$('#deleteBtn').on("click",function(){
    var trip_type=$('#deleteBtn').attr('data-id');
