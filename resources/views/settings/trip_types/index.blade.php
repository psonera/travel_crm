                ...
                <div class="flex-auto px-0 pt-0 pb-2">
                    <div class="p-0 overflow-x-auto">
                        <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                            ...
                            <tbody>
                                @foreach ($trip_types as $index => $trip_type)
                                    <tr>
                                        <td
                                    ...
                                    <div class="relative bg-white align-center justify-center rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-6 text-center">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you
                                                sure you want to delete this Trip Type?
                                            </h3>
                                            <form id="delete-frm" class="DELETE" action="{{ route('settings.trip_types.destroy',  $trip_type) }}" method="POST">
                                                @method('DELETE')
                                                @csrf                                             
