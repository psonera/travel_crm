        ...
        <div class="flex-none max-w-full ml-auto mr-auto px-3 w-full">
            <div
                ...
                <div
                    ...
                    <h2 class="text-3xl font-bold">Edit Lead Source</h2>
                </div>
                <div class="flex-auto p-6" role="tabpanel">
                    <form role="form" method="POST" action="{{ route('settings.lead_sources.update',$lead_source) }}">
                        ...
                        <fieldset class="border border-solid border-gray-300 p-6">
                            ...
                            <div class="mb-4">
                                <x-inputs.text name="name" label="{{ __('Name') }}" value="{{ $lead_source->name }}" autocomplete="name" autofocus />
                            </div>
                            @error('name')
