                                    ...
                                    <div class="relative bg-white align-center justify-center rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-6 text-center">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you
                                             ...
                                             <form id="delete-frm" class="DELETE" action="{{ route('settings.lead_sources.destroy',  $lead_source) }}" method="POST">
                                                @method('DELETE')
                                                @csrf                                             
                                            <button id="delete-frm" class="deletebtn" data-modal-toggle="popup-modal" type="submit" href="{{ route('settings.lead_sources.destroy',  $lead_source) }}"
