                                ...
                                @foreach ($trips as $index => $trip)
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <a href="{{ route('settings.trips.edit', $trip) }}"
                            ...
                            <div class="inline-block align-center bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-1/4">
                                <div class="relative bg-white align-center justify-center rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div class="p-6 text-center">
                                        ...
                                        <form id="delete-frm" class="DELETE" action="{{ route('settings.trips.destroy',  $trip) }}" method="POST">
                                            @method('DELETE')
                                            @csrf                                             
                                            <button id="delete-frm" data-modal-toggle="popup-modal" type="submit" class="deletebtn text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                                Yes, I'm sure
                                            </button>
                                            <button  class="cancelbtn" data-modal-toggle="popup-modal" onclick="toggleModal()" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">No,
                                                cancel
                                            </button>
                                        </form>
                                    </div>
