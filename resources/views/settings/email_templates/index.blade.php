                            ...
                            <tbody>
                                @foreach ($email_templates as $index => $email_template)
                                    <tr>
                                        ...
                                        <a onclick="toggleModal('{{ $email_template->id }}')" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 rounded-full focus:ring-4 focus:ring-red-300 font-medium text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900 cursor-pointer"> Delete</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
...
var email_template=$('#deleteBtn').attr('data-id');
...
$.ajax({
    ...
    var token = $('meta[name="csrf_token"]').attr('content');
        ...
        url: "email_templates/"+email_template,
        dataType: 'json',
