        ...
        <div class="flex-none max-w-full ml-auto mr-auto px-3 w-full">
            <div
                ...
                <div
                    ...
                    <h2 class="text-3xl font-bold">Create Email Template</h2>

                </div>
                <div class="flex-auto p-6" role="tabpanel">
                    <form role="form" method="POST" action="{{ route('settings.email_templates.store') }}">
                        @csrf
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <x-inputs.text name="subject" label="{{ __('Subject') }}" value="{{ old('subject') }}"
                                required autocomplete="subject" autofocus />
                        </div>

                        <div class="mb-4">
                            <x-inputs.textarea name="content" label="{{ __('Content') }}" value="{{ old('content') }}"
