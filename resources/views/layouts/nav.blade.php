          ...
          <path fill-rule="evenodd"
            ...
            clip-rule="evenodd"></path>
                ...
                <a href="index.html" class="text-xl font-bold flex items-center lg:ml-2.5">
                    <img src="/images/logo.svg" class="h-6 mr-2" alt="Travel CRM Logo">
                    <span class="self-center whitespace-nowrap">Travel CRM</span>
                </a>
          ...
          <path fill-rule="evenodd"
            ...
            clip-rule="evenodd"></path>
                ...
                <div class="hidden lg:flex items-center">
                    ...
                    <div class="-mb-1">
                        <a class="github-button" href="https://github.com/themesberg/Travel CRM-tailwind-css-dashboard" data-color-scheme="no-preference: dark; light: light; dark: light;" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star themesberg/Travel CRM-tailwind-css-dashboard on GitHub">Star</a>
                    </div>
                </div>
                <a href="pricing/index.html" class="hidden sm:inline-flex ml-5 text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center items-center mr-3">
