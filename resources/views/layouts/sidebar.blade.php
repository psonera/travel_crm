<aside class="max-w-62.5 ease-nav-brand fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent">
    <div class="h-19.5">
        ...
        <a class="block px-8 py-6 m-0 text-size-sm whitespace-nowrap text-slate-700" href="javascript:;" target="_blank">
            <img src="/img/logo-ct.svg" class="inline h-full max-w-full transition-all duration-200 ease-nav-brand max-h-8" alt="main_logo" />
            <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">Travel CRM</span>
        </a>
    </div>
    ...
    <div class="items-center block w-auto max-h-screen h-sidenav grow basis-full">
        <ul class="flex flex-col pl-0 mb-0">
            <li class="mt-0.5 w-full"> 
                <a class="{{ request()->is('/') ? 'shadow-soft-xl bg-white font-semibold' : ''}}  py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg  px-4 text-slate-700 transition-colors" href="{{ route('dashboard') }}">
                    <div class="{{ request()->is('/') ? 'bg-gradient-fuchsia' : ''}} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
            ...
            <li class="mt-0.5 w-full">
                <a class="{{ (request()->is('leads/*') || request()->is('leads')) ? 'shadow-soft-xl bg-white font-semibold' : ''}} py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg  px-4 text-slate-700 transition-colors" href="{{ route('leads.index') }}">
                    <div class="{{ (request()->is('leads/*') || request()->is('leads')) ? 'bg-gradient-fuchsia' : ''}} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
            ...
            <li class="mt-0.5 w-full">
                <a class="{{ (request()->is('quotation/*') || request()->is('quotation')) ? 'shadow-soft-xl bg-white font-semibold' : ''}} py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="{{ route('leads.index') }}">
                    <div class="{{ (request()->is('quotation/*') || request()->is('quotation')) ? 'bg-gradient-fuchsia' : ''}} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="mt-0.5 w-full">
                <a class="{{ (request()->is('products/*') || request()->is('products')) ? 'shadow-soft-xl bg-white font-semibold' : ''}} py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors cursor-pointer" href="{{ route('products.index') }}">
                    <div class="{{ (request()->is('products/*') || request()->is('products')) ? 'bg-gradient-fuchsia' : ''}} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current stroke-0 text-center xl:p-2.5">
            ...
            <li class="mt-0.5 w-full">
                <a class="{{ (request()->is('lead_managers/*') || request()->is('lead_managers')) ? 'shadow-soft-xl bg-white font-semibold' : ''}} py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg  px-4 text-slate-700 transition-colors" href="{{ route('lead_managers.index') }}">
                    <div class="{{ (request()->is('lead_managers/*') || request()->is('lead_managers')) ? 'bg-gradient-fuchsia' : ''}} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
