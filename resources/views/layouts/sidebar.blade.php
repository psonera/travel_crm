    ...
    <div class="items-center block w-auto max-h-screen h-sidenav grow basis-full">
        <ul class="flex flex-col pl-0 mb-0">
            ...
            <li class="w-full mt-4 mb-2">
                <h6 class="pl-6 ml-2 font-bold leading-tight uppercase text-size-lg text-black opacity-60">Account
                    pages</h6>
            </li>

            <li class="mt-0.5 w-full">
                <a class="{{ request()->is('profile/*') || request()->is('profile') ? 'shadow-soft-xl bg-white font-semibold' : '' }} ease-nav-brand flex font-semibold items-center mx-4 my-0 px-4 py-2.7 rounded-lg text-black text-lg text-size-sm text-slate-700 transition-colors whitespace-nowrap"
                    href="{{ route('settings.users.edit', Auth::user()) }}">
                    <div
                        class="{{ request()->is('profile/*') || request()->is('profile') ? 'bg-gradient-orange' : '' }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
            ...
            <li class="mt-0.5 w-full">
                <a class="{{ request()->is('logout') ? 'shadow-soft-xl bg-white font-semibold' : '' }} ease-nav-brand flex font-semibold items-center mx-4 my-0 px-4 py-2.7 rounded-lg text-black text-lg text-size-sm text-slate-700 transition-colors whitespace-nowrap"
                    href="{{ route('logout') }}">
                    <div
                        class="{{ request()->is('logout') ? 'bg-gradient-orange' : '' }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
