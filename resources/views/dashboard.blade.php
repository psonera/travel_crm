                ...
                <div class="flex-auto p-4">
                    <div class="flex flex-row -mx-3">
                        ...
                        <div class="px-3 text-right basis-1/3">
                            <div class="inline-block w-12 h-12 text-center rounded-lg bg-gradient-orange">
    ...
    <div class="flex flex-wrap mt-6 -mx-3">
        <div class="w-full max-w-full px-3 mt-0 lg:w-7/12 lg:flex-none">
            <div
                ...
                <div class="flex-auto p-4">
                    <div>
                        <canvas id="chart-line" width="400" height="347"></canvas>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div
                ...
                <div class="flex-auto p-4">
                    <div class="py-4 pr-1 mb-4 bg-gradient-dark-gray rounded-xl">
                        <div>
                            <canvas id="chart-bars" height="230"></canvas>
                        </div>
                    </div>
                    ...
                    <div class="w-full px-6 mx-auto max-w-screen-2xl rounded-xl">
                        <div class="flex flex-wrap mt-0 -mx-3">
                            <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                ...
                                <h4 class="font-bold">{{ $total_user }}</h4>
                            ...
                            <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                <div class="flex mb-2">
                                    ...
                                    <p class="mt-1 mb-0 font-semibold leading-tight text-size-xs">Leads</p>
                                </div>
                                <h4 class="font-bold">{{ $leads->count() }}</h4>
                                <div class="text-size-xs h-0.75 flex w-3/4 overflow-visible rounded-lg bg-gray-200">
                            ...
                            <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                <div class="flex mb-2">
                                    ...
                                    <p class="mt-1 mb-0 font-semibold leading-tight text-size-xs">Product Sales</p>
                                </div>
                                <h4 class="font-bold">₹{{ $product_sales }}</h4>
                                <div class="text-size-xs h-0.75 flex w-3/4 overflow-visible rounded-lg bg-gray-200">
                            ...
                            <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                <div class="flex mb-2">
                                                ...
                                                <g transform="translate(-2020.000000, -442.000000)" fill="#FFFFFF"
                                                    ...
                                                    <g transform="translate(1716.000000, 291.000000)">
                                                        <g transform="translate(304.000000, 151.000000)">
                                                            ...
                                                            <path class="color-background"
                                                                d="M33.785,11.285 L28.715,6.215 L34.0616667,0.868333333 C32.82,0.315 31.4483333,0 30,0 C24.4766667,0 20,4.47666667 20,10 C20,10.99 20.1483333,11.9433333 20.4166667,12.8466667 L2.435,27.3966667 C0.95,28.7083333 0.0633333333,30.595 0.00333333333,32.5733333 C-0.0583333333,34.5533333 0.71,36.4916667 2.11,37.89 C3.47,39.2516667 5.27833333,40 7.20216667,40 C9.26666667,40 11.2366667,39.1133333 12.6033333,37.565 L27.1533333,19.5833333 C28.0566667,19.8516667 29.01,20 30,20 C35.5233333,20 40,15.5233333 40,10 C40,8.55166667 39.685,7.18 39.1316667,5.93666667 L33.785,11.285 Z">
                                                            </path>
                                                        </g>
                                                    </g>
                                                </g>
                                    ...
                                    <p class="mt-1 mb-0 font-semibold leading-tight text-size-xs">Products</p>
                                </div>
                                <h4 class="font-bold">{{ $total_products }}</h4>
                                <div class="text-size-xs h-0.75 flex w-3/4 overflow-visible rounded-lg bg-gray-200">
                ...
                <div class="border-black/12.5 mb-0 rounded-t-2xl border-b-0 border-solid bg-white p-6 pb-0">
                    <div class="flex flex-wrap mt-0 -mx-3">
                        <div class="flex-none w-7/12 max-w-full px-3 mt-0 lg:w-1/2 lg:flex-none">
                            <h6 class="text-lg">Leads</h6>
                            <p class="mb-0 leading-normal text-size-sm">
                                <i class="fa fa-check text-cyan-500"></i>
                                <span class="ml-1 font-semibold">{{ $won_leads_count }} done</span> this month
                            </p>
                        </div>
                    </div>
                </div>
