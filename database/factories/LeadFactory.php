...
class LeadFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'lead_type_id' => \App\Models\LeadType::factory(),
            'lead_source_id' => \App\Models\LeadSource::factory(),
            'lead_pipeline_id' => \App\Models\LeadPipeline::factory(),
            'lead_pipleline_stage_id' => \App\Models\LeadPipelineStage::factory(),
            'lead_pipeline_stage_id' => \App\Models\LeadStage::factory(),
